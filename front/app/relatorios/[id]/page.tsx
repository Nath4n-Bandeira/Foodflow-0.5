...
import { Search, History, Calendar, TrendingUp, ArrowLeft, Thermometer, Download, AlertTriangle } from "lucide-react"
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        ></div>
                        <div>
                          <p className="text-[#444444] font-medium">{item.nome}</p>
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-[#90a1b9]">{validadeDate.toLocaleDateString("pt-BR")}</p>
                      </div>
                    </div>
                  )
                })}
                ...
                <div className="lg:col-span-1">
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[#444444] text-xs">0-10°C: Frio</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full bg-[#00c950]"></div>
                      <span className="text-[#444444] text-xs">10-20°C: Ideal</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded-full bg-[#f59e0b]"></div>
                      <span className="text-[#444444] text-xs">20-25°C: Atenção</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="lg:col-span-2">
                  <div className="h-[300px] w-full">
                    {tempLoading ? (
                      ...
                      <div className="flex items-center justify-center h-full">
                        <p className="text-[#90a1b9]">Nenhum histórico de temperatura disponível</p>
                      </div>
                    )}
                  </div>
                </div>
