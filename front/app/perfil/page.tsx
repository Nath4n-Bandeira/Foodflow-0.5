    ...
    <main className="min-h-screen bg-slate-50 font-sans">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12 items-center">
            <div className="md:col-span-1 flex justify-center">
              <div className="w-40 h-40 bg-green-600 rounded-full flex items-center justify-center shadow-lg shadow-green-500/30">
                <span className="text-6xl font-bold text-white select-none">{getInitial(cliente?.nome)}</span>
              </div>
            </div>
      ...
      <section className="container mx-auto px-6 py-12 md:py-16">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
          <h2 className="text-3xl font-bold text-gray-900">Dispensas Criadas por Você</h2>
          <div>
        ...
        {dispensasCriadas.length > 0 ? (
          ...
          <div className="text-center py-12 bg-white rounded-2xl border border-slate-200">
            <p className="text-slate-500">Você ainda não criou nenhuma dispensa.</p>
          </div>
        )}
      </section>

      <section className="container mx-auto px-6 py-4 md:py-8 pb-16">
        ...
        {dispensasMembro.length > 0 ? (
          ...
          <div className="text-center py-12 bg-white rounded-2xl border border-slate-200">
            <p className="text-slate-500">Você ainda não participa de nenhuma outra dispensa.</p>
          </div>
        )}
      </section>
    </main>
